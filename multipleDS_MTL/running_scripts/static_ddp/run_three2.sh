...
KILL_PROC="kill $(ps aux | grep static_ddp_train2.py | grep -v grep | awk '{print $2}')"
TRAIN_FILE=static_ddp_train2.py
...
CFG_PATH=$TRAIN_ROOT/cfgs/three_task/static_ddp/cifar10_minicoco_voc/$YAML_CFG

SCH="cosine"
OPT="adamw"
LR="1e-4"
GAMMA="0.1"
ADD_DISC="manual_balancing"
