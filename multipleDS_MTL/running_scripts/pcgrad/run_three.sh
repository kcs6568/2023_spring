...
KILL_PROC="kill $(ps aux | grep pcgrad_train.py | grep -v grep | awk '{print $2}')"
TRAIN_FILE=pcgrad_train.py
...
CFG_PATH=$TRAIN_ROOT/cfgs/three_task/pcgrad/cifar10_minicoco_voc/$YAML_CFG

SCH="cosine"
OPT="adamw"
LR="1e-4"
GAMMA="0.1"
ADD_DISC="simpleClip_AMP"
