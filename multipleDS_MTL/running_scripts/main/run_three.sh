...
KILL_PROC="kill $(ps aux | grep main_train.py | grep -v grep | awk '{print $2}')"
TRAIN_FILE=main_train.py
...
CFG_PATH=$TRAIN_ROOT/cfgs/three_task/main/cifar10_minicoco_voc/$YAML_CFG
