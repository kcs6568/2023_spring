...
KILL_PROC="kill $(ps aux | grep uw_train.py | grep -v grep | awk '{print $2}')"
TRAIN_FILE=uw_train.py
...
CFG_PATH=$TRAIN_ROOT/cfgs/three_task/uw/cifar10_minicoco_voc/$YAML_CFG
