...
def get_model_complexity_info(model, batch, data_type, task,
    ...
    if backend == 'pytorch':
        flops_count, params_count, output = get_flops_pytorch(model, batch, data_type, task,
    ...
    return flops_count, params_count, output
