...
from engines import DP_static_engines
...
def main(args):
    ...
    if args.validate_only:
        ...
        results = DP_static_engines.evaluate(
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # for i, (dset, loader) in enumerate(train_loaders.items()):
        #     if getattr(loader, "sampler") is not None:
        #         loader.sampler.set_epoch(epoch)
        #     elif getattr(loader, "batch_sampler") is not None:
        #         loader.batch_sampler.sampler.set_epoch(epoch)
        ...
        if not args.resume_tmp:
            ...
            once_train_results = DP_static_engines.training(
                model, 
                optimizer, 
                train_loaders, 
                epoch, 
    ...
    if is_main_process:
        ...
        loss_csv_path = os.path.join(csv_dir, f"allloss_result_gpu.csv")
        ...
        acc_csv_path = os.path.join(csv_dir, f"allacc_result_gpu.csv")
